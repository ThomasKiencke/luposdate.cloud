 ...
 */
public class Old_HBaseLoadUDF extends LoadFunc implements StoreFuncInterface,
		LoadPushDown, OrderedLoadFunc {

	private static final Log LOG = LogFactory.getLog(Old_HBaseLoadUDF.class);
	 ...
	 * @throws IOException
	 */
	public Old_HBaseLoadUDF(String columnList, String optList)
			throws ParseException, IOException {
		this(columnList, optList, null);
	}

	public Old_HBaseLoadUDF(String columnList, String optString, String rowKey,
